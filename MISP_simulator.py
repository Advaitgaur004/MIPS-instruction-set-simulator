class MIPSCompiler:
    def __init__(self):
        # Define register mappings with integer values
        self.registers = {
            '$zero': 0, '$0': 0,
            '$at': 1, '$v0': 2, '$v1': 3,
            '$a0': 4, '$a1': 5, '$a2': 6, '$a3': 7,
    ...
    def compile_instruction(self, instruction, line_address):
        ...
        # I-type instructions: lw, sw, beq, addi
            ...
            # Immediate arithmetic: addi
                ...
                rt = parts[2] #Source register
                rs = parts[1]  #Destination register
                imm = int(parts[3])  # Immediate value
                # Convert the immediate to 16-bit binary with sign extension
    ...
    def compile_file(self, filename="test_code_1_mips_sim.asm"):
        try:
...
class MIPSSimulator:
    def __init__(self, compiler):
        ...
        self.registers = {f'${i}': 0 for i in range(32)}  # Initialize all registers to 0
        self.memory = {}  # Simulated main memory
        self.pc = 0x00400000  # Program counter
        
        # Initialize special registers
        self.registers['$zero'] = 0  # Always holds 0
        self.registers['$sp'] = 0x7FFFFFFC  # Stack pointer
    ...
    def load_data_to_memory(self):
        ...
        for label, value in self.compiler.data_section.items():
            ...
            self.memory[address] = value  # Load value into memory
    ...
    def execute_instruction(self, instruction):
        ...
        # I-type instructions
        elif op == '001000':  # addi opcode
            rs = int(binary[6:11], 2)  # Source register
            rt = int(binary[11:16], 2)  # Destination register
            imm = int(binary[16:], 2)  # Immediate value

            # Convert imm to signed integer (if negative)
            if imm >= 2**15:
                imm -= 2**16

            # Perform addition and store result in destination register
        ...
        # Jump instruction
            ...
            #here upper 4 bits of pc is preserved
    ...
    def execute_program(self, instructions):
        ...
        # Load data into memory before executing instructions
        ...
        for instruction in instructions:
            ...
            # # Print all registers after each instruction
...
def main():
    ...
    test_file = "test_code_5_mips_sim.asm"
